...
You can unignore individual files or entire directories, as well as re-ignore parts of unignored directories:
...
# this should be placed after unignoring the parent directory
.emacs.d/elpa/
```
