...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:background "#113354" :foreground "#ffffff" :box nil))))
   ...
   `(hl-line ((,class (:background "#0e1a28"))))
   ...
   `(company-tooltip ((,class (:foreground "#d3e8f3" :background "#0b1118"))))
   `(company-tooltip-selection ((,class (:foreground "#d3e8f3" :background "#0e1a28"))))
   `(company-tooltip-scrollbar-thumb ((,class (:background "#55bcda"))))
   `(company-tooltip-scrollbar-track ((,class (:background "#090E15"))))
